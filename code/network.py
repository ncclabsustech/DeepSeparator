...
class DeepSeparator(nn.Module):
    ...
    def forward(self, x, indicator):
        ...
        output_1 = self.conv2_1_1(output)
        output_2 = self.conv2_1_2(output)
        output_3 = self.conv2_1_3(output)
        output_4 = self.conv2_1_4(output)
        output = torch.cat((output_1, output_2, output_3, output_4), dim=1)
        output = torch.relu(output)
        output_skip_connect_x = output

        output_1 = self.conv2_2_1(output)
        output_2 = self.conv2_2_2(output)
        output_3 = self.conv2_2_3(output)
        output_4 = self.conv2_2_4(output)
        output = torch.cat((output_1, output_2, output_3, output_4), dim=1)
        output = torch.sigmoid(output)

        output_1 = self.conv2_3_1(output)
        output_2 = self.conv2_3_2(output)
        output_3 = self.conv2_3_3(output)
        output_4 = self.conv2_3_4(output)
        output = torch.cat((output_1, output_2, output_3, output_4), dim=1)
        output = torch.sigmoid(output)
        output = output + output_skip_connect_x

        output_1 = self.conv2_4_1(output)
        output_2 = self.conv2_4_2(output)
        output_3 = self.conv2_4_3(output)
        output_4 = self.conv2_4_4(output)
        output = torch.cat((output_1, output_2, output_3, output_4), dim=1)
